...
; Mise injections - https://mise.jdx.dev/mise-cookbook/neovim.html#run-commands
; TODO make less standard script runners work with this
; Also, I'm not using the is-mise predicate currently but I may change my mind
